...
class Main18 extends  Component{
    ...
    render(){
        return(
            <>
        <div className="fala">
        <input type="radio" name="option1"/>Diariamente cada {this.state.number} dias(s)<br/>
...
<input type="radio" name="option1"/>Semanalmente cada {this.state.tato} semana(s)<br/>
...
<input type="radio" name="option1"/>Mensualmente cada {this.state.tuyo} mes(es)<br/>
