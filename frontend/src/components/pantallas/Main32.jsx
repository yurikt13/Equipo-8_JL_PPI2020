...
class Main16 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      carpa: <svg width="50px" height="50px" viewBox="0 0 16 16" className="bi bi-alarm mt-3 iconalarm text-success" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
