...
class Main5 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            icon: <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-heart text-success" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    cambiarMensaje = () => this.setState({
        icon1: <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-heart-fill text-success heart1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="card border-secondary mt-3 card1">
                        ...
                        <div className="card-footer border-secondary">
                            <div className="btn-group mr-auto mt-lg-5 w-10">
                                ...
                                <svg width="5em" height="1em" viewBox="0 0 16 16" className="bi bi-house-door-fil coment1" fill="currentColor" xmlns="http://www.w3.org/2000/svg" />
                                ...
                                <svg width="5em" height="1em" viewBox="0 0 16 16" className="bi bi-house-door-fill save1" fill="currentColor" xmlns="http://www.w3.org/2000/svg"></svg>
                    ...
                    <div className="card mt-3 border-secondary card2">
                        ...
                        <div className="card-footer border-secondary">
                            <div className="btn-group mr-auto mt-0 mt-lg-5 w-10">
                                ...
                                <svg width="5em" height="1em" viewBox="0 0 16 16" className="bi bi-house-door-fill coment2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" />
                                <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-chat-fill text-success" fill="currentColor" xmlns="http://www.w3.org/2000/svg" >
                                    <path d="M8 15c4.418 0 8-3.134 8-7s-3.582-7-8-7-8 3.134-8 7c0 1.76.743 3.37 1.97 4.6-.097 1.016-.417 2.13-.771 2.966-.079.186.074.394.273.362 2.256-.37 3.597-.938 4.18-1.234A9.06 9.06 0 0 0 8 15z" ></path>
                                </svg>

                                <svg width="5em" height="1em" viewBox="0 0 16 16" className="bi bi-house-door-fill save2" fill="currentColor coment2" xmlns="http://www.w3.org/2000/svg"></svg>
                                <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-bookmark-fill text-success" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.74.439L8 13.069l-5.26 2.87A.5.5 0 0 1 2 15.5V2z" />
                                </svg>
                    ...
                    <div className="card border-secondary mt-3 card3">
                        ...
                        <div className="card-footer border-secondary">
                            <div className="btn-group mr-auto mt-0 mt-lg-5 w-10">
                                ...
                                <svg width="5em" height="1em" viewBox="0 0 16 16" className="bi bi-house-door-fill coment3" fill="currentColor" xmlns="http://www.w3.org/2000/svg" />
                                <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-chat-fill text-success" fill="currentColor" xmlns="http://www.w3.org/2000/svg" >
                                    <path d="M8 15c4.418 0 8-3.134 8-7s-3.582-7-8-7-8 3.134-8 7c0 1.76.743 3.37 1.97 4.6-.097 1.016-.417 2.13-.771 2.966-.079.186.074.394.273.362 2.256-.37 3.597-.938 4.18-1.234A9.06 9.06 0 0 0 8 15z" ></path>
                                </svg>

                                <svg width="5em" height="1em" viewBox="0 0 16 16" className="bi bi-house-door-fill save3" fill="currentColor" xmlns="http://www.w3.org/2000/svg"></svg>
                                <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-bookmark-fill text-success" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.74.439L8 13.069l-5.26 2.87A.5.5 0 0 1 2 15.5V2z" />
                                </svg>
